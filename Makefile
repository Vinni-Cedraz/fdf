...
#    Updated: 2023/01/20 19:05:33 by vcedraz-         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
NAME_WIP = wip.a
EXECUTABLE = fdf
CFLAGS = -Wall -Wextra -Werror -Imlx -I$(PRNTF_PATH)includes -Iincludes -Iincludes/polymorphism_methods_and_classes_bonus/ -O3
