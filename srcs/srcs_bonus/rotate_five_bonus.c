...
/*   Updated: 2023/01/30 21:38:07 by vcedraz-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void			check_state_before_rotfive(t_data *d);

inline void	rotate_five_around_x(t_data *d)
{
	check_state_before_rotfive(d);
...
static inline void	check_state_before_rotfive(t_data *d)
{
